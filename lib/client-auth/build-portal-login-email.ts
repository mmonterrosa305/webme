...
export function buildPortalLoginEmail({
  ...
  const html = `
    <div style="font-family: Arial, Helvetica, sans-serif; max-width: 640px; margin: 0 auto; color: #171717; line-height: 1.6;">
      ...
      <p style="margin: 0 0 24px;">Click below to securely sign in. This link expires soon and can only be used once.</p>
  ...
  const text = isWelcome
    ...
    : `Sign in to your MyWebMe client portal for ${businessName}:\n\n${magicLink}\n\nIf you did not request this email, you can ignore it.`;
